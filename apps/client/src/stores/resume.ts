...
import type { CustomSectionGroup, SectionKey } from "@resume-space/schema";
import { defaultSection } from "@resume-space/schema";
import { removeItemInLayout } from "@resume-space/utils";
