...
import { Alert, AlertDescription, AlertTitle, Button } from "@resume-space/ui";
...
export const VerifyEmailPage = () => {
  ...
  return (
    <div className="space-y-6">
      <Helmet>
        <title>
          {t`Verify your email address`} - {t`Resume Space`}
        </title>
      </Helmet>
      ...
      <div className="space-y-2">
        ...
        <p className="leading-relaxed opacity-75">
          <Trans>
            You should have received an email from <strong>Resume Space</strong> with a link to
            verify your account.
          </Trans>
        </p>
      </div>
