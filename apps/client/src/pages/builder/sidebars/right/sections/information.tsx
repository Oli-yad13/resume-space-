  ...
  <Card className="space-y-4 bg-info text-info-foreground">
    <CardContent className="space-y-2">
      ...
      <CardDescription className="space-y-2">
        <Trans>
          <p>
            I built Resume Space mostly by myself during my spare time, with a lot of help from
  ...
  <Card className="space-y-4">
    <CardContent className="space-y-2">
      ...
      <CardDescription className="space-y-2">
        <Trans>
          <p>
            The community has spent a lot of time writing the documentation for Resume Space, and
