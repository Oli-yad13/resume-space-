...
import type { ResumeDto } from "@resume-space/dto";
import { createResumeSchema } from "@resume-space/dto";
import { idSchema, sampleResume } from "@resume-space/schema";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
import { cn, generateRandomName } from "@resume-space/utils";
...
export const ResumeDialog = () => {
  ...
  const onSubmit = async (values: FormValues) => {
    if (isCreate) {
      ...
      // Show AI job recommendations notification
      setTimeout(() => {
        toast({
          variant: "info",
          title: t`Your resume is ready!`,
          description: t`Check out AI-powered job recommendations tailored for you.`,
          action: (
            <ToastAction altText={t`View Jobs`} onClick={() => window.location.href = "/jobs"}>
              {t`View Jobs`}
            </ToastAction>
          ),
        });
