...
import type { JsonResume, LinkedIn, ReactiveResumeV3 } from "@resume-space/parser";
import {
  JsonResumeParser,
  LinkedInParser,
  ReactiveResumeParser,
  ReactiveResumeV3Parser,
} from "@resume-space/parser";
...
import { parseResumeFile } from "@/client/services/resume/parse-file";
  ...
  const onValidate = async () => {
    try {
      ...
      if (error instanceof ZodError) {
        ...
        // Non-Zod errors (e.g. the AI parse endpoint failing or AI being unavailable).
        const description =
        ...
        <Form {...form}>
          <form className="space-y-4">
            <DialogHeader>
              ...
              <DialogDescription>
                {t`Upload a file from one of the accepted sources to parse existing data and import it into Resume Space for easier editing.`}
              </DialogDescription>
            </DialogHeader>
