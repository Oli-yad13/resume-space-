...
import { AuthProvidersDto, LoginDto, RegisterDto, UserWithSecrets } from "@resume-space/dto";
...
export class AuthService {
  ...
  async forgotPassword(email: string) {
    ...
    const subject = "Reset your Resume Space password";
  ...
  async setup2FASecret(email: string) {
    ...
    const uri = authenticator.keyuri(email, "Resume Space", secret);
