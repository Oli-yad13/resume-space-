...
import { cn, hexToRgb, isEmptyString, isUrl, sanitize } from "@resume-space/utils";
  ...
  return (
    ...
    >
      {(!slice || slice.showHeader) && (
        <h4 data-pagination-header className="mb-2 border-b border-primary text-base font-bold">
          {section.name}
        </h4>
      )}
