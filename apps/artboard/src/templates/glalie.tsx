...
const Summary = () => {
  ...
  return (
    <section id={section.id} data-pagination-section={section.id} data-pagination-gap={12}>
      {(!slice || slice.showHeader) && (
        <h4 data-pagination-header className="mb-2 border-b pb-0.5 text-sm font-bold">
          {section.name}
        </h4>
      )}
    ...
    >
      {(!slice || slice.showHeader) && (
        <h4
          ...
          className="mb-2 border-b pb-0.5 text-sm font-bold group-[.sidebar]:text-primary"
        >
          {section.name}
        </h4>
      )}
