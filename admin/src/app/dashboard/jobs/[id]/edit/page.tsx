  ...
  if (fetching) {
    return (
      <div className="flex h-96 items-center justify-center">
        <div className="text-zinc-400">Loading job...</div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <h1 className="mt-4 text-3xl font-bold text-white">Edit Job</h1>
        <p className="mt-1 text-sm text-zinc-400">Update job posting details</p>
      </div>

      {/* The form is exactly the same as the new page, just with different title and submit action */}
